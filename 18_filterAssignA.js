...
console.log(`Employees whoes have company name 'Wipro' => `);
wiproEmployee.forEach(element => element.getDetails());
console.log(`Avarage of Salary whoes company name is Wipro ==> ${avarageOfWiproEmp}`);
...
console.log(`Employees whoes having company  name is 'Wipro' and 'Infy' => `);
wiproAndInfyComp.forEach(element=>element.getDetails());
console.log(`Avarage of salary whoes company name is Wipro and Infy ==> ${avarageEmpSalary}`); 