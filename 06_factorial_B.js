...
console.log(`Find factorial of given string`);
let factorialOfWordsCount = function (str) {
    ...
    if (numLength==0 || numLength==1) {
        console.log(`Total no of words in given string ="${str}" => '${numLength}'`);
        return 1;
    }
    if (numLength<0 ) {
...
console.log(`Factorial result is ==> '${factorialOfWordsCount("Reshma Prabhakar Bhuse")}'\n`);